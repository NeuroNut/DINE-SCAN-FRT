...
// Reading the raw JSON data from the request body
...
if (!isset($orderData['table_number']) || !isset($orderData['total_amount']) || !isset($orderData['mobile_number']) || !isset($orderData['items'])) {
...
try {
    ...
    $query = "INSERT INTO orders (table_number, total_amount, mobileNumber) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param('idd', $tableNumber, $totalAmount, $mobileNumber);
    $stmt->execute();
